...
| :----------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------- | :------ |
| [Abstract Factory](./Contents/CreationalPatterns/_01_AbstractFactory_抽象工厂模式.md) | **抽象工厂**：提供一个创建一组相关或依赖对象族的抽象接口                                  | [[↗]]() |
| [Builder](./Contents/CreationalPatterns/_02_Builder_建造者模式.md) | **建造者**：将一个复杂对象的构建与它的表示分离                          | [[↗]]() |
| [Factory Method](./Contents/CreationalPatterns/_03_Factory_工厂模式.md) | **工厂方法**：定义一个创建对象的接口，由子类决定实例化对象 | [[↗]]() |
| [Prototype](./Contents/CreationalPatterns/_04_Prototype_原型模式.md) | **原型**：复制现有的对象原型来创建新对象                                    | [[↗]]() |
| [Singleton](./Contents/CreationalPatterns/_05_Singleton_单例模式.md) | **单例**：确保一个类仅有一个实例和唯一全局访问点。                                                | [[↗]]() |
